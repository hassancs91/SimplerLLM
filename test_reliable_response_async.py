from SimplerLLM.language.llm_addons import generate_pydantic_json_model_reliable_async
...
async def main():
    ...
    # Generate the Pydantic model using the reliable LLM with async function
    response = await generate_pydantic_json_model_reliable_async(
